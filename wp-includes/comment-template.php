...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		...
		'url'    => '<p style="display:none" class="comment-form-url"><label for="url">' . __( 'Website' ) . '</label> ' .
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label style="    width: 100%;    display: block;    font-weight: bold;" for="comment">Ваш отзыв</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" aria-required="true" required="required"></textarea></p>',
