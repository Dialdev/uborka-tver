...
class WWP_Wholesale_Prices
{
    ...
    public static function get_product_wholesale_price_on_shop_v3($product_id, $user_wholesale_role)
    {
        ...
        $price_arr['wholesale_price_with_tax'] = WWP_Helper_Functions::wwp_get_price_including_tax(wc_get_product($product_id), array('qty' => 1, 'price' => $price_arr['wholesale_price_raw']));
