...
/**
	внес изменения в шорткод product_category
*/
	/**
	...
	public static function product_category( $atts ) {
		...
		extract( shortcode_atts( array(
			...
			'order'    => 'desc',
			'category' => '',  // Slugs
			// Добавил изменения, чтобы учитывать тэги
			'tags' => '',  // Tags 
		...
		//print_r( apply_filters( 'woocommerce_shortcode_products_query', $args, $atts ) );
		...
		if ( $products->have_posts() ) : ?>
			...
			<?php woocommerce_product_loop_start(); ?>
				...
				<?php while ( $products->have_posts() ) : $products->the_post(); ?>
					...
					<?php wc_get_template_part( 'content', 'novproduct' ); ?>
