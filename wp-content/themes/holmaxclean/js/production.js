...
$(document).ready(function() {
	...
	$('.one-product form > .number .controls .minus, .one-item-page .information .inputs-and-soc-services>div:first-child form>.number .controls .minus').click(function () {
    ...
    $('.one-product form > .number .controls .plus,.one-item-page .information .inputs-and-soc-services>div:first-child form>.number .controls .plus').click(function () {
        var $input = $(this).closest('.input-wrapper').find('input[type="text"]');
	...
	$('.one-product form>.number .input-wrapper,.one-item-page .information .inputs-and-soc-services>div:first-child form>.number .input-wrapper').on('change', 'input[type="text"]', function(){
		var val = $(this).val();
		if (val <= 0){
			$(this).val('1');
		}
    ...
    $(function () {
        filter_keys.numbers($('.one-product form>.number .input-wrapper input[type="text"], .one-item-page .information .inputs-and-soc-services>div:first-child form>.number .input-wrapper input[type="text"]'),
...
$.fn.viewer = function() {
	...
	function carousel() {
		var carouselWindow = $('.carousel-window');
		var posLeft = 0;
		var flag = 0;

		var totalFlags = $(thumbs).size()/3;
		totalFlags = totalFlags - (totalFlags%1);

		var prevArrow = $('.controls div:first-child');
		var nextArrow = $('.controls div:last-child');
		...
		$(thumbs).on('click', function() {
			if($(this).hasClass('active') == false) {
				...
				$(image).closest('.img-wrapper').find('a.fancybox').attr('href', imgSrc);
				imgLoad();
				return false;
			} else {
				return false;
